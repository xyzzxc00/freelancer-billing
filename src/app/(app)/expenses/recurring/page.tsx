...
import { toggleRecurringExpenseAction, deleteRecurringExpenseAction } from "./actions";
    ...
    <div className="px-4 sm:px-6 py-6 mx-auto w-full max-w-7xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <div>
          ...
          <Link href="/expenses/recurring/new" className="text-sm text-accent hover:underline block mb-4">
            + 新增定期支出
          </Link>
                ...
                return (
                  <div key={r.id} className="border border-border rounded-lg px-4 py-3.5">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <Link href={`/expenses/recurring/${r.id}`} className="text-xs text-foreground-muted hover:text-foreground">
                        編輯
                      </Link>
                      <ConfirmDeleteButton
                        action={deleteAction}
